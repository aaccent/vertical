...
const closePopupBtns = document.querySelectorAll('[data-action="close-popup"]')
...
export function openPopup(name: string, onOpenedClass="") {
	...
	if(onOpenedClass === ""){
		...
		targetPopup.classList.add("opened",onOpenedClass)
	}
